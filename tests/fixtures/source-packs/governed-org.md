...
sources:
  - source_id: governed-org-about
    ...
    sensitivity: holon-private
    published_at: 2026-05-01
    snapshot_path: tests/fixtures/snapshots/governed-org-about.md
  - source_id: governed-org-updates
    source_type: markdown
    canonical_url: https://valid-org.example/updates
    title: Valid Organisation Updates
    permission_mode: link-and-summarise
    published_at: null
    snapshot_path: tests/fixtures/snapshots/governed-org-updates.md
