...
- **Agent memory (`~/.claude/.../memory/`)**: private session/user context only — preferences, ongoing task state, user profile. **Never put research findings here**; they belong in the repo.
